...
def _run_schema_migrations(engine):
    ...
    migrations = [
        ...
        # Billing custom-invoice email delivery outcome (added 2026-09-22)
        ("billing_invoices", "last_send_status", "VARCHAR(20) DEFAULT NULL", None),
        ("billing_invoices", "last_send_error", "TEXT DEFAULT NULL", None),
        ("billing_invoices", "last_send_at", "DATETIME DEFAULT NULL", None),
...
app.include_router(compliance_tracker.router, prefix="/v1")
