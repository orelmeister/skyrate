              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 mb-6">
                ...
                <ul className="space-y-3 text-slate-700 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span><strong>May 29, 2026:</strong> Form 471 filing deadline for FY2026. All funding requests must be submitted by this date. See <a href="https://www.usac.org/e-rate/" target="_blank" rel="noopener noreferrer" className="text-purple-700 hover:text-purple-900 underline font-medium">USAC&apos;s published E-Rate dates and deadlines</a> for every milestone through July 2027.</span>
                  </li>
                  <li className="flex items-start gap-3">
