...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      {/* ════════════════════ HEADER ════════════════════ */}
      <header className="sticky top-0 z-50 border-b border-slate-200 px-4 sm:px-6 py-3 bg-white/95 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 lg:gap-8">
            <a href="#features" className="text-slate-600 hover:text-indigo-600 transition font-medium text-sm lg:text-base">Features</a>
            <a href="#for-consultants" className="text-slate-600 hover:text-indigo-600 transition font-medium text-sm lg:text-base">For Consultants</a>
            <a href="#for-vendors" className="text-slate-600 hover:text-indigo-600 transition font-medium text-sm lg:text-base">For Vendors</a>
            <a href="#pricing" className="text-slate-600 hover:text-indigo-600 transition font-medium text-sm lg:text-base">Pricing</a>
            <a href="#faq" className="text-slate-600 hover:text-indigo-600 transition font-medium text-sm lg:text-base">FAQ</a>
          </nav>

          <div className="flex items-center gap-3">
            <Link href="/sign-in" className="hidden sm:inline text-slate-600 hover:text-slate-900 transition font-medium text-sm">
              Sign In
            </Link>
            <Link href="/sign-up" className="px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 transition shadow-lg shadow-indigo-500/25 font-medium text-sm">
              Start Free Trial
            </Link>
            <MobileMenuButton />
          </div>
        ...
        {/* CSS-only mobile menu: checkbox + dropdown must be siblings for peer-checked */}
        <input type="checkbox" id="mobile-menu-toggle" className="hidden peer" />
        <div className="hidden peer-checked:block md:!hidden border-t border-slate-100 mt-3 pt-3 pb-1">
          <nav className="flex flex-col gap-3">
            <a href="#features" className="text-slate-600 hover:text-indigo-600 font-medium py-1">Features</a>
            <a href="#for-consultants" className="text-slate-600 hover:text-indigo-600 font-medium py-1">For Consultants</a>
            <a href="#for-vendors" className="text-slate-600 hover:text-indigo-600 font-medium py-1">For Vendors</a>
            <a href="#pricing" className="text-slate-600 hover:text-indigo-600 font-medium py-1">Pricing</a>
            <a href="#faq" className="text-slate-600 hover:text-indigo-600 font-medium py-1">FAQ</a>
            <Link href="/sign-in" className="text-indigo-600 font-medium py-1 sm:hidden">Sign In</Link>
          </nav>
        </div>
      </header>
      ...
      <section className="relative overflow-hidden px-4 sm:px-6 py-16 sm:py-20 lg:py-28">
        <div className="absolute inset-0 z-0">
          <Image src="/images/backgrounds/hero.png" alt="" fill className="object-cover opacity-15" priority />
          <div className="absolute inset-0 bg-gradient-to-br from-slate-50/90 via-indigo-50/80 to-purple-50/90" />
        </div>
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-100 text-indigo-700 rounded-full text-sm font-medium mb-6 sm:mb-8">
              <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
              Trusted by 500+ E-Rate Professionals
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-5 sm:mb-6 leading-tight">
              Stop Leaving{" "}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-8 sm:mb-12">
              <Link
                href="/sign-up"
                className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition shadow-xl shadow-indigo-500/30 text-base sm:text-lg"
              >
                Start Your 14-Day Free Trial
              </Link>
              <a
                href="#demo"
                className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 border-2 border-slate-300 rounded-xl font-semibold text-slate-700 hover:bg-white hover:border-indigo-300 transition text-base sm:text-lg flex items-center justify-center gap-2"
              >
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
            {/* Illustration - hidden on mobile, shown on lg */}
            ...
            <div className="lg:col-span-3">
              ...
              <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
                ...
                <div className="p-5 sm:p-6 rounded-2xl bg-amber-50 border border-amber-100">
                ...
                <div className="p-5 sm:p-6 rounded-2xl bg-orange-50 border border-orange-100">
      ...
      {/* ════════════════════ FEATURES / SOLUTION ════════════════════ */}
      <section id="features" className="py-14 sm:py-20 px-4 sm:px-6 relative overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-800">
        <div className="absolute inset-0 z-0">
          <Image src="/images/backgrounds/network.png" alt="" fill className="object-cover opacity-10" />
        </div>
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6">
            {[
              { icon: "school", title: "Real-Time USAC Data", desc: "Direct API integration with USAC Open Data Portal" },
              { icon: "ai", title: "AI-Powered Analysis", desc: "Advanced AI denial analysis and appeal generation" },
              { icon: "dashboard", title: "Portfolio Management", desc: "Track schools, vendors, and funding across cycles" },
              { icon: "funding", title: "Instant Insights", desc: "Natural language queries return answers in seconds" },
            ].map((f) => (
              <div key={f.icon} className="p-4 sm:p-6 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 text-center">
                <div className="w-12 h-12 sm:w-14 sm:h-14 mx-auto mb-3 sm:mb-4 bg-white/20 rounded-xl flex items-center justify-center">
                  <Image src={`/images/icons/${f.icon}.png`} alt="" width={28} height={28} />
                </div>
                <h3 className="text-sm sm:text-lg font-semibold text-white mb-1 sm:mb-2">{f.title}</h3>
                <p className="text-purple-100 text-xs sm:text-sm">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ════════════════════ STATS ════════════════════ */}
      <section className="py-12 sm:py-16 px-4 sm:px-6 relative overflow-hidden bg-white border-y border-slate-100">
        <div className="absolute inset-0 z-0">
          <Image src="/images/backgrounds/data.png" alt="" fill className="object-cover opacity-[0.08]" />
        </div>
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-center">
            {[
              { val: "$50M+", label: "E-Rate Funding Tracked" },
              { val: "5,000+", label: "Schools Managed" },
              { val: "87%", label: "Appeal Success Rate" },
              { val: "10hrs", label: "Saved Per Week" },
            ].map((s) => (
              <div key={s.label}>
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-indigo-600">{s.val}</div>
                <div className="text-slate-600 mt-1 sm:mt-2 text-sm sm:text-base">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-indigo-100 text-indigo-600 flex items-center justify-center mx-auto mb-4 sm:mb-6 text-xl sm:text-2xl font-bold">
                1
              </div>
            ...
            <div className="text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-purple-100 text-purple-600 flex items-center justify-center mx-auto mb-4 sm:mb-6 text-xl sm:text-2xl font-bold">
                2
              </div>
            ...
            <div className="text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-pink-100 text-pink-600 flex items-center justify-center mx-auto mb-4 sm:mb-6 text-xl sm:text-2xl font-bold">
                3
              </div>
      ...
      <section id="pricing" className="py-14 sm:py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            {/* Applicant */}
            <div className="p-6 sm:p-8 rounded-2xl border-2 border-emerald-200 bg-gradient-to-br from-emerald-50 to-white">
              ...
              <div className="mb-4 sm:mb-6">
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl sm:text-4xl font-bold text-slate-900">$200</span>
              ...
              <Link href="/applicant/sign-up" className="block w-full py-2.5 sm:py-3 text-center bg-emerald-600 text-white rounded-xl font-semibold hover:bg-emerald-700 transition text-sm sm:text-base">
                Start Free Trial
              </Link>
            </div>

            {/* Consultant */}
            <div className="p-6 sm:p-8 rounded-2xl border-2 border-indigo-200 bg-gradient-to-br from-indigo-50 to-white relative overflow-hidden">
              <div className="absolute top-3 right-3 sm:top-4 sm:right-4">
                <span className="px-2 sm:px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full text-xs font-semibold">MOST POPULAR</span>
              </div>
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
              ...
              <div className="mb-4 sm:mb-6">
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl sm:text-4xl font-bold text-slate-900">$300</span>
                  <span className="text-slate-600">/month</span>
                </div>
              ...
              <Link href="/sign-up?role=consultant" className="block w-full py-2.5 sm:py-3 text-center bg-indigo-600 text-white rounded-xl font-semibold hover:bg-indigo-700 transition text-sm sm:text-base">
                Start Free Trial
              </Link>
            </div>

            {/* Vendor */}
            <div className="p-6 sm:p-8 rounded-2xl border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-white sm:col-span-2 lg:col-span-1">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
                <Image src="/images/icons/vendor.png" alt="" width={28} height={28} />
              ...
              <Link href="/sign-up?role=vendor" className="block w-full py-2.5 sm:py-3 text-center bg-purple-600 text-white rounded-xl font-semibold hover:bg-purple-700 transition text-sm sm:text-base">
                Start Free Trial
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 sm:space-y-6">
            {[
              ...
              <div key={faq.q} className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-slate-200">
